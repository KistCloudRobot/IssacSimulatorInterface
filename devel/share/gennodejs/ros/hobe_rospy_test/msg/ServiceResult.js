...
class ServiceResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.actionID, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ServiceResult(null);
    // Deserialize message field [actionID]
    data.actionID = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.actionID);
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ServiceResult(null);
