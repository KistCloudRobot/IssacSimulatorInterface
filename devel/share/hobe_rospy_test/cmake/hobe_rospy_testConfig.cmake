...
if(NOT "/home/uosai/catkin_ws/devel/include " STREQUAL " ")
  set(hobe_rospy_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/uosai/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hobe_rospy_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uosai/catkin_ws/src/hobe_rospy_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/uosai/catkin_ws/devel/lib;/opt/ros/noetic/lib)
